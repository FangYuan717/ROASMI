...
def prepare_candidates_data(data_path,normalize=True):
...
def get_marginals(candidates, args:IdentifyArgs, rep, normalize=True, norm_order_scores=False):
...
if __name__ == '__main__':
    ...
    candidates = prepare_candidates_data(IdentifyArgs.identify_path,normalize=True)
