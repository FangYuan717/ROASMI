...
class CommonArgs(Tap):
    ...
    checkpoint_paths: List[str] = ['/ROASMI.pt',]
    """List of paths to model checkpoints (:code:`.pt` files)."""
    RT_interval: int = 30
    """The retention interval for generating training pairs."""
    gpu: int = None
    """Which GPU to use."""
...
class TrainArgs(CommonArgs):
    ...
    data_path: str = '/data/initial_reference_set.csv'
    ...
    MODEL_FILE_NAME: str = '(re)train_ROASMI.pt'
    """ Save file names"""
    TEST_SCORES_FILE_NAME: str = 'test_scores.csv'
    """ Save file names"""
    TRAIN_LOGGER_NAME: str = '(re)train'
    """Logger names"""
    SAVE_PATH_NAME: str = '(re)train.csv'
    epochs: int = 250
